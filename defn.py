...
def searchinuitstudent():
    ...
    if ch1==1:
        display.display_uit_student()
        college.search_into_uit_student1()
        print("\n\nAre you Want to search more 'Y' for Yes/'N' for No")
        ch2=input("\t\tEnter Y or N")
        if ch2=='Y' or ch2=='y':
            searchinuitstudent()
        ...
        display.display_uit_student()
        college.search_into_uit_student2()
        print("\n\nAre you Want to Search more'Y' for Yes/'N' for No")
        ch2=input("\t\tEnter Y or N")
        if ch2=='Y' or ch2=='y':
            searchinuitstudent()
        ...
        display.display_uit_student()
        college.search_into_uit_student3()
        print("\n\nAre you Want to Search more'Y' for Yes/'N' for No")
        ch2=input("\t\tEnter Y or N")
        if ch2=='Y' or ch2=='y':
            searchinuitstudent()
